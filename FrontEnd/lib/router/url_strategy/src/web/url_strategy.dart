...
class PathUrlStrategy extends ui_web.HashUrlStrategy {
  ...
  ///
  /// CDN Setup path
  /// PathUrlStrategy(cdnPathRemove:"CDN Path")

  PathUrlStrategy([super.platformLocation, String? cdnPathRemove])
      : _platformLocation = platformLocation,
        _basePath = stripTrailingSlash(extractPathname(checkBaseHref(
          platformLocation.getBaseHref() != null ? "/" : null,
        )));
