  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ResponsiveBuilder(builder: (context, size) {
        final crossAxisCount = AppUtils.gridViewCount(
            elementWidth: 340, crossAxisSpacing: 10, extra: 32);
            ...
            SliverPadding(
              ...
              sliver: SliverList(
                delegate: SliverChildListDelegate([
                  ...
                  const ContactCard(),
                  20.ph,
                  EmploymentCard(crossAxisCount: crossAxisCount),
                  20.ph,
                  const EducationCard(),
                  20.ph,
                  const SkillsCard(),
                  ...
                  const CoursesCard(),
                  20.ph,
                  ProjectsCard(crossAxisCount: crossAxisCount),
                  40.ph,
                ]),
              ),
            ),
