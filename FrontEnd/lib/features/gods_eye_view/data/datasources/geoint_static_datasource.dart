...
class GeointStaticDataSourceImpl implements GeointStaticDataSource {
  ...
  List<CctvCameraContact> getCctvCameras() {
    return const [
      ...
      CctvCameraContact(
        ...
        title: 'Shibuya Scramble North Cam',
        position: const LatLng(35.659695, 139.700539),
        city: 'Tokyo, Japan',
      ...
      CctvCameraContact(
        ...
        title: 'Shinjuku Crossing East Cam',
        position: const LatLng(35.689614, 139.700523),
        city: 'Tokyo, Japan',
        cameraName: 'Shinjuku East Crossing Pilot',
        snapshotUrl:
      ...
      CctvCameraContact(
        ...
        title: 'Shinjuku Station West Cam',
        position: const LatLng(35.690976, 139.699237),
        city: 'Tokyo, Japan',
        cameraName: 'Shinjuku West Terminal Pilot',
        snapshotUrl:
            'https://images.unsplash.com/photo-1536098561742-ca998e48cbcc?w=600&auto=format&fit=crop&q=80',
        bearingDeg: 128.0,
        fovDeg: 72.0,
      ),
    ];
  ...
  List<InfrastructureContact> getInfrastructure() {
    return const [
      ...
      InfrastructureContact(
        id: 'inf_cable_hermosa',
        title: 'Hermosa Beach Subsea Landing (CA)',
        position: LatLng(33.8622, -118.3995),
        category: 'Submarine Fiber Optic Cable',
        details: 'Trans-Pacific gateway connecting North America to East Asia',
        capacity: '60 Terabits/sec',
      ),
      InfrastructureContact(
        id: 'inf_cable_bude',
        title: 'Bude Subsea Landing Station (UK)',
        position: LatLng(50.8281, -4.5444),
        category: 'Submarine Fiber Optic Cable',
        details: 'Apollo / Grace Hopper transatlantic ultra-low latency subsea terminus',
        capacity: '340 Terabits/sec',
      ),
      InfrastructureContact(
        id: 'inf_cable_toucheng',
        title: 'Toucheng Subsea Landing (Taiwan)',
        position: LatLng(24.8636, 121.8015),
        category: 'Submarine Fiber Optic Cable',
        details: 'Asia-Pacific C2C / NCP / TSE-1 subsea nexus station',
        capacity: '160 Terabits/sec',
      ),
      InfrastructureContact(
        id: 'inf_cable_changi',
        title: 'Changi North Subsea Gateway (Singapore)',
        position: LatLng(1.3890, 103.9870),
        category: 'Submarine Fiber Optic Cable',
        details: 'SEA-ME-WE-5 / SingTel Southeast Asian digital gateway',
        capacity: '24 Terabits/sec',
      ),
      InfrastructureContact(
        id: 'inf_cable_naha',
        title: 'Naha Subsea Landing (Okinawa, Japan)',
        position: LatLng(26.2124, 127.6806),
        category: 'Submarine Fiber Optic Cable',
        details: 'Okinawa-Taiwan / East Asia Crossing Pacific cable station',
        capacity: '12 Terabits/sec',
      ),
      InfrastructureContact(
        id: 'inf_cable_fujairah',
        title: 'Fujairah Subsea Hub (UAE)',
        position: LatLng(25.1217, 56.3337),
        category: 'Submarine Fiber Optic Cable',
        details: 'Middle East Interconnect Hub (FLAG / FEA / SMW4)',
        capacity: '40 Terabits/sec',
      ),
      InfrastructureContact(
        id: 'inf_cable_santos',
        title: 'Santos Subsea Landing (Brazil)',
        position: LatLng(-23.9618, -46.3281),
        category: 'Submarine Fiber Optic Cable',
        details: 'South Atlantic Cable System & Monet subsea gateway',
        capacity: '64 Terabits/sec',
      ),
      InfrastructureContact(
