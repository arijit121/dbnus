...
class _ModelConfigCardState extends State<ModelConfigCard> {
  ...
  void initState() {
    super.initState();
    // Auto-collapse if already initialized
    _isExpanded = !widget.isInitialized;
  }

  @override
  void didUpdateWidget(covariant ModelConfigCard oldWidget) {
    super.didUpdateWidget(oldWidget);
    // Auto-collapse when initialization completes successfully
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          // Linear Progress Indicator Bar during Initialization
          ...
          // Header Bar (Clickable to toggle expansion)
          InkWell(
            onTap: () {
              setState(() {
                ...
                children: [
                  ...
                  if (widget.isInitializing) ...[
                    ...
                    Container(
                      ...
                      child: const Row(
                        children: [
                          Icon(Icons.downloading_rounded, size: 16, color: Colors.indigoAccent),
                          SizedBox(width: 8),
                          Expanded(
                            child: Text(
                              'Downloading model weights & initializing backend runtime...',
                              style: TextStyle(
                                fontSize: 11,
                                fontWeight: FontWeight.w500,
                                color: Colors.indigoAccent,
