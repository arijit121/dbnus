...
class GlbModel extends GlbModelEntity {
  ...
  static const List<GlbModel> presetModels = [
    GlbModel(
      ...
      assetPath: 'assets/models/3d/damaged_helmet.glb',
      defaultScale: 1.8,
    ...
    GlbModel(
      ...
      assetPath: 'assets/models/3d/duck.glb',
      defaultScale: 1.4,
    ...
    GlbModel(
      ...
      assetPath: 'assets/models/3d/cesium_man.glb',
      defaultScale: 2.0,
    ...
    GlbModel(
      ...
      assetPath: 'assets/models/3d/avocado.glb',
      defaultScale: 15.0,
